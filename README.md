...
[![Build](https://img.shields.io/github/actions/workflow/status/pumPCin/LSPosed/core.yml?branch=master&event=push&logo=github&label=Build)](https://github.com/pumPCin/LSPosed/actions/workflows/core.yml?query=event%3Apush+branch%3Amaster+is%3Acompleted) [![Crowdin](https://img.shields.io/badge/Localization-Crowdin-blueviolet?logo=Crowdin)](https://lsposed.crowdin.com/lsposed) [![Channel](https://img.shields.io/badge/Follow-Telegram-blue.svg?logo=telegram)](https://t.me/LSPosed) [![Chat](https://img.shields.io/badge/Join-QQ%E9%A2%91%E9%81%93-red?logo=tencent-qq&logoColor=red)](https://qun.qq.com/qqweb/qunpro/share?_wv=3&_wwv=128&inviteCode=Xz9dJ&from=246610&biz=ka) [![Download](https://img.shields.io/github/v/release/pumPCin/LSPosed?color=orange&logoColor=orange&label=Download&logo=DocuSign)](https://github.com/pumPCin/LSPosed/releases/latest) [![Total](https://shields.io/github/downloads/pumPCin/LSPosed/total?logo=Bookmeter&label=Counts&logoColor=yellow&color=yellow)](https://github.com/pumPCin/LSPosed/releases)
...
- For stable releases, please go to [Github Releases page](https://github.com/pumPCin/LSPosed/releases)
- For canary build, please check [Github Actions](https://github.com/pumPCin/LSPosed/actions/workflows/core.yml?query=branch%3Amaster)

Note: debug builds are only available in Github Actions.

## Get Help
**Only bug reports from **THE LATEST DEBUG BUILD** will be accepted.**
- GitHub issues: [Issues](https://github.com/pumPCin/LSPosed/issues/)
